...
namespace ClassManager
{
	...
	public sealed partial class OrganizationDetail : Page
	{
		...
		private List<NavMenuItem> navlist = new List<NavMenuItem>(
			new[]
			{
				//https://msdn.microsoft.com/zh-cn/library/windows/apps/windows.ui.xaml.controls.symbol.aspx icon网站
				new NavMenuItem()
				{
					Symbol = Symbol.People,
					Label = "Members",
					DestPage = typeof(Members)
				},
				new NavMenuItem()
				{
					Symbol = Symbol.Message,
					Label = "Notices",
					DestPage = typeof(Notices)
				},
				new NavMenuItem()
				{
					Symbol = Symbol.LikeDislike,
					Label = "Votes",
					DestPage = typeof(Votes)
				},
				new NavMenuItem()
				{
		...
		public static OrganizationDetail Current = null;

		/// <summary>
		/// Initializes a new instance of the OrganizationDetail, sets the static 'Current' reference,
		...
		/// </summary>
		public event TypedEventHandler<OrganizationDetail, Rect> TogglePaneButtonRectChanged;
